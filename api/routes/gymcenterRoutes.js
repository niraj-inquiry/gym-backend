...
const { gymcenterRegister, get_gym_all_data, gym_locationbase_data,
   gym_delete_all_record,gym_delete_by_id,get_gym_data_by_id,
    updategymaccount, gym_country_list, gym_data_by_country,
     get_verify_all_data, get_center_list_by_userid,
      deactivatecenter, center_search_data,updategymfeaturebyid } = require('../controllers/gymcentersControllers');
...
router.post('/gymcenter-register',uploadfile.fields([{name:"centerBanner",maxCount:1}]), gymcenterRegister)
...
router.put('/update-gym-center-data', upload.array('image', 12),updategymaccount)
